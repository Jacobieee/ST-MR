...
def read_data(args, data_type):
  ...
  excludes = [
      "seq_start_end",
      "obs_kp_rel", "obs_kp", "cur_activity", "future_activity",
      "pred_kp", "person_boxid2key"]
...
def evaluate(dataset, config, sess, tester):
  ...
  # save_file = "single_future_out.npy"
  # all_preds = np.zeros([34180, 12, 2])
